...
# Sometimes we might add links to MD files that are not supposed
# to necessarily work in the Myst-parsed docs, instead they will
# work in GitHub, for example. This suppresses the warnings when
# making the docs. You may or may not want to do this!
